        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          {(type === 'short_answer' || type === 'fill_blank') && (
            <div>
              ...
              <input style={inp} value={answer} onChange={e => setAnswer(e.target.value)} placeholder={type === 'fill_blank' ? 'e.g. Lagos, photosynthesis, 42' : 'e.g. H2O, osmosis, 1914'} />
              <p style={{ fontSize: '0.75rem', color: '#6b6b65', marginTop: '0.375rem' }}>?? Not case sensitive — exact match required</p>
            </div>
          )}
