...
export default function ProprietorSettingsPage() {
  ...
  async function handleLogoUpload(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      setLogoUrl(`${SUPABASE_URL}/storage/v1/object/public/school-logos/${fileName}`)
    } catch {
  ...
  async function handleSaveLogo() {
    ...
    try {
      const res = await apiFetch(`${API}/schools/settings`, { method: 'PATCH', body: JSON.stringify({ logoUrl }) })
        ...
        <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'flex-start', flexWrap: 'wrap' as const }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              ...
              {saved && <p style={{ fontSize: '0.875rem', color: '#0f4a32', fontWeight: 500 }}>✅ Logo saved successfully!</p>}
